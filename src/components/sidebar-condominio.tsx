...
const menuConfig: SidebarMenuItem[] = [
  {
    key: "home",
    icon: Home,
    labelKey: "sidebar.condominio.menu.home",
    to: "/condominio/home",
  },
  {
    key: "unidades",
  ...
  },
  {
    key: "financeiro",
    icon: Wallet,
    labelKey: "sidebar.condominio.menu.financeiro",
    submenuKey: "financeiro",
    children: [
      { labelKey: "sidebar.condominio.menu.contasPagar", to: "/condominio/contas-pagar" },
      { labelKey: "sidebar.condominio.menu.balancete", to: "/condominio/balancete" },
      { labelKey: "sidebar.condominio.menu.boletos", to: "/condominio/boletos" },
    ],
  },
  {
    key: "reunioes",
  ...
  },
  {
    key: "avisos",
    icon: MessageSquare,
    labelKey: "sidebar.condominio.menu.avisos",
    to: "/condominio/avisos",
  },
];

export function SidebarCondominio() {
              ...
              return (
                ...
                >
                  ...
                  {hasChildren && isSubmenuOpen && isOpen && (
                    <ul
                      id={`${item.key}-submenu`}
                      className="ml-6 mt-2 space-y-2 border-l border-emerald-400/40 pl-4"
                    >
